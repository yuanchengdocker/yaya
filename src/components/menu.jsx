            ...
            <section className="sidebar">
                ...
                <ul className="sidebar-menu" data-widget="tree">
                    ...
                    <ul className="treeview-menu">
                        <li className={this.state.active=="index"?"active":""}><a href="#/index" onClick={this.menuChange.bind(this,"index")}><i className="fa fa-circle-o"></i> Dashboard v1</a></li>
                        <li className={this.state.active=="index2"?"active":""}><a href="#/index2" onClick={this.menuChange.bind(this,"index2")}><i className="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                    </li>
